...
@section("head")
    @vite(['resources/css/styles.css', 'resources/js/scripts.js', 'resources/js/datatables-simple.js'])
@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatablesSimple" class="table table-bordered text-center bg-success text-white">
                                <thead>
                                <tr>
                                    <th>Назва</th>
                                    <th>Розміри</th>
